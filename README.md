...
|---|---|---|---|---|
| EPH continua | 04, 09a, 10, 12, 13a, 13b, 03b | Trimestral | <a href="https://www.indec.gob.ar/indec/web/Institucional-Indec-BasesDeDatos" target="_blank" rel="noopener">Página INDEC — Bases de microdatos</a> (vía `eph::get_microdata` en `00`)<br>`https://www.indec.gob.ar/indec/web/Institucional-Indec-BasesDeDatos` | `00` → `01` → `02` → scripts viz |
| EPH Total Urbano | 06 | Anual (3T) | <a href="https://www.indec.gob.ar/indec/web/Institucional-Indec-BasesDeDatos" target="_blank" rel="noopener">Página INDEC — Bases de microdatos</a> (personas, Total Urbano)<br>`https://www.indec.gob.ar/indec/web/Institucional-Indec-BasesDeDatos` | Reemplazar raw TU → `06_prep` → `06` viz |
| SIPA | 03, 05 | Mensual | Portal OEDE / Min. Capital Humano (*Trabajo registrado* y serie de remuneraciones provinciales; el nombre del Excel cambia con el mes). Sin URL estable en el pipeline. | Reemplazar xlsx en `data/raw_data/sipa/` → prep → viz |
| SRT empresas | 07 | Mensual | <a href="https://www.srt.gob.ar/estadisticas/series/co/up/Serie_historica_Segun_Jurisdiccion%20-%20Ubicacion%20Persona%20Trabajadora%20-%20UP.xlsx" target="_blank" rel="noopener">Descarga directa del Excel SRT (serie UP)</a><br>`https://www.srt.gob.ar/estadisticas/series/co/up/Serie_historica_Segun_Jurisdiccion%20-%20Ubicacion%20Persona%20Trabajadora%20-%20UP.xlsx` | Borrar xlsx en `data/raw_data/srt/` (o dejar que descargue si no está) → `07_prep` → `07` viz |
| OPEX INDEC | 14 | Anual | <a href="https://www.indec.gob.ar/indec/web/Nivel4-Tema-3-2-79" target="_blank" rel="noopener">Página INDEC — Origen provincial de las exportaciones</a> (desde ahí bajar el xls vigente)<br>`https://www.indec.gob.ar/indec/web/Nivel4-Tema-3-2-79` | Descargar xls OPEX → `14_prep*` → viz |
| CEPAL VAB 52 sectores | 15 | Cuando publiquen | <a href="https://repositorio.cepal.org/server/api/core/bitstreams/539fcce5-8977-4061-a222-fbfd7358a35f/content" target="_blank" rel="noopener">Descarga directa del Excel CEPAL (VAB 52 sectores)</a><br>`https://repositorio.cepal.org/server/api/core/bitstreams/539fcce5-8977-4061-a222-fbfd7358a35f/content` | Borrar/reemplazar Excel en `data/raw_data/pbg/` → `15_prep` → `15_pbg` |
| TOP / RON Min. Economía | 16 | Anual | <a href="https://www.argentina.gob.ar/sites/default/files/serie_top_1984_2024_1.xlsx" target="_blank" rel="noopener">Descarga directa TOP</a><br>`https://www.argentina.gob.ar/sites/default/files/serie_top_1984_2024_1.xlsx`<br><a href="https://www.argentina.gob.ar/sites/default/files/serie_ron_2003_2025.xlsx" target="_blank" rel="noopener">Descarga directa RON</a><br>`https://www.argentina.gob.ar/sites/default/files/serie_ron_2003_2025.xlsx`<br>(los nombres de archivo en el portal pueden cambiar) | Reemplazar xlsx en `data/raw_data/finanzas/` → `16_prep` → viz |
| Ejecuciones APNF Min. Economía | 17 | Anual | <a href="https://www.argentina.gob.ar/economia/sechacienda/coordinacion-fiscal-provincial/ejecucion-presupuestaria-provincial/ejecuciones" target="_blank" rel="noopener">Página Min. Economía — Ejecuciones APNF</a> (desde ahí bajar el xlsx vigente)<br>`https://www.argentina.gob.ar/economia/sechacienda/coordinacion-fiscal-provincial/ejecucion-presupuestaria-provincial/ejecuciones` | Reemplazar `serie_aif-apnf-*.xlsx` → `17_prep` → viz |
...
Si el texto dice **«Descarga directa…»**, el link apunta al archivo (Excel/xls), no a una página intermedia: el navegador suele bajarlo al instante. Si dice **«Página…»**, hay que entrar y elegir el archivo vigente. La URL en monoespaciado es la misma dirección, para copiar o verificar. Detalle de hoja y nombre de archivo: fichas metodológicas más abajo. Después de regenerar PNG: `rmarkdown::render("informe/monitor_la_rioja.Rmd")`.
